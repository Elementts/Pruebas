...
(function($) {	
	...
	v = $.tools.validator = {
		...
		/* The Error Messages */
		messages: {
			"*": { en: "Favor de corregir este campo" }		
		},
...
*/
	...
	*/
	...
	v.fn(":email", "Favor de introducir una direccion de correo valida", function(el, v) {
		return !v || emailRe.test(v);
	});

	v.fn(":url", "Favor de ingresar una URL valida", function(el, v) {
		return !v || urlRe.test(v);
	});

	v.fn(":number", "Favor de ingresar un valor numerico", function(el, v) {
		return numRe.test(v);			
	});

	v.fn("[max]", "Favor de ingresar un valor menor a $1", function(el, v) {
	...
	v.fn("[min]", "Favor de ingresar un valor mayor a $1", function(el, v) {
	...
	v.fn("[required]", "Favor de completar este campo obligatorio", function(el, v) {
