...
namespace SICE
{
	...
	public partial class SICEDataContextDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void InsertDATOS_FISCALE(DATOS_FISCALE instance);
    partial void UpdateDATOS_FISCALE(DATOS_FISCALE instance);
    partial void DeleteDATOS_FISCALE(DATOS_FISCALE instance);
    ...
    partial void InsertESTATUS(ESTATUS instance);
    partial void UpdateESTATUS(ESTATUS instance);
    partial void DeleteESTATUS(ESTATUS instance);
    ...
    partial void DeleteUSUARIO(USUARIO instance);
		...
		public SICEDataContextDataContext() : 
		...
		public SICEDataContextDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public SICEDataContextDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public SICEDataContextDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public SICEDataContextDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<DATOS_FISCALE> DATOS_FISCALEs
		{
			get
			{
				return this.GetTable<DATOS_FISCALE>();
			}
		}
		...
		public System.Data.Linq.Table<ESTATUS> ESTATUS
		{
			get
			{
				return this.GetTable<ESTATUS>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.DATOS_FISCALES")]
	public partial class DATOS_FISCALE : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnRAZON_SOCIALChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DATOS_FISCALE_USUARIO", Storage="_USUARIOs", ThisKey="DATOS_FISCALES_ID", OtherKey="DATOS_FISCALES_ID")]
		...
		{
			this.SendPropertyChanging();
			entity.DATOS_FISCALE = this;
		}
		
		private void detach_USUARIOs(USUARIO entity)
		{
			this.SendPropertyChanging();
			entity.DATOS_FISCALE = null;
		}
	}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.EMPRESA_EMPLEADOS")]
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.ESTATUS")]
	public partial class ESTATUS : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnNOMBREChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="ESTATUS_FACTURA", Storage="_FACTURAs", ThisKey="ESTATUS_ID", OtherKey="ESTATUS_ID")]
	...
	public partial class FACTURA : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<ESTATUS> _ESTATUS;
    ...
    partial void OnADUANA_IDChanged();
		...
		public FACTURA()
		{
			...
			this._ESTATUS = default(EntityRef<ESTATUS>);
		...
		public int ESTATUS_ID
		{
			...
			set
			{
				if ((this._ESTATUS_ID != value))
				{
					if (this._ESTATUS.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnESTATUS_IDChanging(value);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="ESTATUS_FACTURA", Storage="_ESTATUS", ThisKey="ESTATUS_ID", OtherKey="ESTATUS_ID", IsForeignKey=true)]
		public ESTATUS ESTATUS
		{
			get
			{
				return this._ESTATUS.Entity;
			}
			set
			{
				ESTATUS previousValue = this._ESTATUS.Entity;
				if (((previousValue != value) 
							|| (this._ESTATUS.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._ESTATUS.Entity = null;
						previousValue.FACTURAs.Remove(this);
					}
					this._ESTATUS.Entity = value;
					if ((value != null))
					{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.FORMA_PAGOS")]
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.IMPUESTOS_PRODUCTOS")]
    ...
    partial void OnUSUARIO_IDChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="USUARIO_PROVEEDORE", Storage="_USUARIO", ThisKey="USUARIO_ID", OtherKey="USUARIO_ID", IsForeignKey=true)]
		public USUARIO USUARIO
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.TIPO_PAGOS")]
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.TIPO_USUARIOS")]
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.UNIDADES_MEDIDAS")]
	...
	public partial class USUARIO : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<DATOS_FISCALE> _DATOS_FISCALE;
    ...
    partial void OnDATOS_FISCALES_IDChanged();
		...
		public USUARIO()
		{
			...
			this._DATOS_FISCALE = default(EntityRef<DATOS_FISCALE>);
		...
		public int DATOS_FISCALES_ID
		{
			...
			set
			{
				if ((this._DATOS_FISCALES_ID != value))
				{
					if (this._DATOS_FISCALE.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnDATOS_FISCALES_IDChanging(value);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="USUARIO_PROVEEDORE", Storage="_PROVEEDOREs", ThisKey="USUARIO_ID", OtherKey="USUARIO_ID")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DATOS_FISCALE_USUARIO", Storage="_DATOS_FISCALE", ThisKey="DATOS_FISCALES_ID", OtherKey="DATOS_FISCALES_ID", IsForeignKey=true)]
		public DATOS_FISCALE DATOS_FISCALE
		{
			get
			{
				return this._DATOS_FISCALE.Entity;
			}
			set
			{
				DATOS_FISCALE previousValue = this._DATOS_FISCALE.Entity;
				if (((previousValue != value) 
							|| (this._DATOS_FISCALE.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._DATOS_FISCALE.Entity = null;
						previousValue.USUARIOs.Remove(this);
					}
					this._DATOS_FISCALE.Entity = value;
					if ((value != null))
					{
					...
					this.SendPropertyChanged("DATOS_FISCALE");
				}
			}
		}
